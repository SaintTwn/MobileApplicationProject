...
public class PostActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PICK_IMAGE) {
            ...
            if (data != null) {
                ...
                Toast.makeText(this, "Resim yüklenemedi. :( ", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private boolean allClear() {
        if (post_image_uri == null) {
            toast("Lütfen paylaşmak istediğiniz resmi seçiniz!");
            return false;
        }else if (TextUtils.isEmpty(post_title.getText().toString())){
            post_title.setError("Başlık kısmı boş olamaz!");
            return false;
        }else if (TextUtils.isEmpty(post_details.getText().toString())){
            post_details.setError("Detaylar kısmı boş olamaz!");
            return false;
        }else {
            return true;
        }
                ...
                .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(PostActivity.this, "Resim yüklenemedi! " + task.getException(), Toast.LENGTH_SHORT).show();
                            pdialog.dismiss();
                        }
                    }
                });
        ...
        FirebaseFirestore.getInstance().collection("Posts").document(title)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(PostActivity.this, "Gönderi yüklendi! :)", Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(getApplicationContext(), "Oops! Bir şeyler yanlış gitti! :(", Toast.LENGTH_LONG).show();
                    }
                });
    }
